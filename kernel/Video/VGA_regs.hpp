...
namespace VGA
{
	namespace Registers
	{
		...
		*/
		...
		struct Seq_ClockingModeRegister
		{
			/**
		...
		struct Seq_CharacterMapSelectRegister
		{
			/**
		...
		struct Seq_SequencerMemoryModeRegister
		{
			/**
